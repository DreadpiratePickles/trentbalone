---
name: "source-command-provision-status"
description: "Query all provisioned resources for a company and their health status."
---

# source-command-provision-status

Use this skill when the user asks to run the migrated source command `provision-status`.
