...
export function SignInClient({ hasCredentials, hasGoogle, showDemoShortcut = false }: SignInClientProps) {
  const [email, setEmail] = useState("");
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState("");
  const hasAnyProvider = hasCredentials || hasGoogle;
            ...
            <>
              <div
                style={{
                  ...
                  alignItems: "center",
                  gap: 12,
                  margin: hasCredentials ? "20px 0" : "0 0 20px",
                }}
              >
                <div className="divider" style={{ flex: 1 }} />
                <span className="mono" style={{ fontSize: 10, letterSpacing: ".14em", color: "var(--haze)" }}>
                  or
                </span>
                <div className="divider" style={{ flex: 1 }} />
              </div>
